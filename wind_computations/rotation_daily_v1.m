...
for y= 1:length(years_numbers)
    ...
    for m = 1:length(months)
        ...
        nccreate(file_path, 'u_along', 'Dimensions', {'longitude', 192, 'latitude', 128, 'time', 4}, 'Datatype','single', 'FillValue', single(-9999));
        nccreate(file_path, 'u_cross', 'Dimensions', {'longitude', 192, 'latitude', 128, 'time', 4}, 'Datatype','single', 'FillValue', single(-9999));
        nccreate(file_path, 'taux', 'Dimensions', {'longitude', 192, 'latitude', 128, 'time', 4}, 'Datatype','single', 'FillValue', single(-9999));
        nccreate(file_path, 'tauy', 'Dimensions', {'longitude', 192, 'latitude', 128, 'time', 4}, 'Datatype','single', 'FillValue', single(-9999));
        nccreate(file_path, 'tau_along', 'Dimensions', {'longitude', 192, 'latitude', 128, 'time', 4}, 'Datatype','single', 'FillValue', single(-9999));
        nccreate(file_path, 'tau_cross', 'Dimensions', {'longitude', 192, 'latitude', 128, 'time', 4}, 'Datatype','single', 'FillValue', single(-9999));
